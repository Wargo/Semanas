...
// in simulator we redefine to format for Semanas Developer console
...
{\
	NSString * exceptionName = [@"org.semanas." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.semanas";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISemanasNativeItemNone = -1, 
	UISemanasNativeItemSpinner = -2,
	UISemanasNativeItemProgressBar = -3,
	
	UISemanasNativeItemSlider = -4,
	UISemanasNativeItemSwitch = -5,
	UISemanasNativeItemMultiButton = -6,
	UISemanasNativeItemSegmented = -7,
	
	UISemanasNativeItemTextView = -8,
	UISemanasNativeItemTextField = -9,
	UISemanasNativeItemSearchBar = -10,
	
	UISemanasNativeItemPicker = -11,
	UISemanasNativeItemDatePicker = -12,
	
	UISemanasNativeItemInfoLight = -13,
	UISemanasNativeItemInfoDark = -14,
	
	UISemanasNativeItemDisclosure = -15,
	
	UISemanasNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Semanas instances of
