...
/**
 The base class for all Semanas modules
 */
...
/**
 Semanas Platform calls this method on startup.
 */
-(void)startup;

/**
 Semanas Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Semanas Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Semanas Platform calls this method on resume.
 @param sender The sender of the event.
 */
