 ...
 * Copyright (c) 2009-2011 by Semanas, Inc. All Rights Reserved.
...
//@interface SemanasObject : NSObject
//@end

@interface SemanasObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SemanasObject class]])
		{
			for (NSString *key in [[(SemanasObject*)o modules] allKeys])
			{
